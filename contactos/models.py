...
class Person(models.Model):
    ...
    last_name = models.CharField(max_length=120, blank=True, null=True, verbose_name=u'Apellido')
    number = models.CharField(max_length=10, verbose_name=u'Numero')
    phone_number = models.CharField(max_length=10, verbose_name=u'Celular', blank=True)
